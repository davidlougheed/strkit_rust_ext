...
class STRkitAlignedCoords:
    ...
    def ref_coord_at_idx(self, idx: int) -> int: ...
...
class PeakMethylation:
    def __init__(self, am: float, amc: float): ...
...
class CallData:
    ...
    def set_methylation(self, methylation: list[PeakMethylation]): ...
...
class STRkitAlignedSegmentSequenceDataForLocus:
    ...
    def count_motif_size_kmers(self) -> dict[str, int]: ...
...
def get_repeat_count_compostr(tr_seq: str, motif: str) -> tuple[int, int]: ...
