...
pub fn poa_consensus_seq(seqs: &[&str], n_blanks: usize, method: PoaImpl) -> Option<String> {
    match method {
        PoaImpl::RustBio => poa_consensus_seq_rust_bio(seqs, n_blanks),
        PoaImpl::Spoa => poa_consensus_seq_spoa(seqs, n_blanks),
    }
}
