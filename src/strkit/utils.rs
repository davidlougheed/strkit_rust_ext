...
pub fn find_coord_idx_by_ref_pos(aligned_coords: &STRkitAlignedCoords, target: usize, start_left: usize) -> (usize, bool) {
    let t = target as u64;
...
pub fn find_coord_idx_by_ref_pos_py(aligned_coords: &Bound<'_, STRkitAlignedCoords>, target: usize, start_left: usize) -> (usize, bool) {
